...
set "msg=【错误】无法检测到 Office ClickToRun 服务..."
goto :end
)
...
if %_Office16% equ 0 (
set "msg=【错误】未检测到 Office 2016/2019 产品..."
goto :end
)
...
if "%ProductIds%" equ "" (
set "msg=【错误】无法检测到 Office 产品 ID..."
goto :end
)
if not exist "%_LicensesPath%\*.xrm-ms" (
set "msg=【错误】无法检测到 Office 许可证文件..."
goto :end
)
if not exist "%_Integrator%" (
set "msg=【错误】无法检测到  Office 许可证积分器..."
goto :end
)
if %winbuild% lss 9200 if not exist "%_OSPP%" (
set "msg=【错误】无法检测到许可证工具 OSPP.vbs..."
goto :end
)
